...
class FilterBar extends Component {
  ...
  render() {
    return (
      <Navbar fluid className="searchBar">
        <Navbar.Header>
          <Navbar.Toggle />
        </Navbar.Header>
        <Navbar.Collapse>
          <Navbar.Form pullLeft>
            <FormGroup>
              <FormControl
                type="text"
                placeholder="Search Problem ID, title, or tag"
            ...
            <NavWrap>
              <ToggleButtonGroup type="checkbox">
                <ToggleButton
                  value={1}
                  onChange={() => {
                    this.props.filtered("finished", true);
                  }}
                >
                  Solved
                </ToggleButton>
                {/* <ToggleButton
                  value={2}
                  onChange={() => {
                    this.props.filtered("isPremium", false);
                  }}
                >
                  Free Only
                </ToggleButton> */}
              ...
              <DiffDropdown
                clicked={this.diffDropdownHandler}
